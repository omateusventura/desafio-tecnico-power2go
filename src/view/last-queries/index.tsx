    ...
    >
      <thead className="sticky top-0">
        ...
        <tr className="bg-white border-b border-b-slate-100">
          <th className="w-[320px] text-start text-sm text-slate-900 font-bold px-2 py-2.5">
            Data de consulta
          </th>
          <th className="w-[800px] text-start text-sm text-slate-900 font-bold px-2 py-2.5">
            Consulta
          </th>
          <th></th>
        </tr>
